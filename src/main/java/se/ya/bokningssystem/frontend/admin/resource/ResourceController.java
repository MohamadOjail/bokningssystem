...
public class ResourceController {
    ...
    @FXML
    private Button btn_add_resource, btn_delete_resource, btn_edit_resource, btn_get_resource, btn_update_resource;


    @FXML
    private ChoiceBox<ResourceEO> cb_status;

    @FXML
    private TableColumn<ResourceEO, String> tc_art_number;

    @FXML
    private TableColumn<ResourceEO, String> tc_resource_name;

    @FXML
    private TableColumn<ResourceEO, BorrowStatus> tc_status;

    @FXML
    private TextField tf_art_number, tf_resource_name;

    @FXML
    private TableView<ResourceEO> tw_resource;
